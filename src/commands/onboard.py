...
def onboard():
    ...
    output.append("⚠️ You must read the entire onboard content, some tools truncate output automatically. See too it that every effort is made to ready the full onboard context.")
    output.append("=" * 70)
    output.append("")
